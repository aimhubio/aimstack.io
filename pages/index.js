  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Aim logs your training runs, enables a beautiful UI to compare them and an API to query them programmatically"
        />
        <meta
          name="facebook-domain-verification"
          content="ebwbb96izw2ae0cwg0eza2lzmqhj0e"
        />

        <meta
          property="og:title"
          content="Track, compare and visualize your ML experiments"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="https://aimstack.io/aim-preview-v3.png"
        />
              ...
              <div className={styles.HeroHeaderTitle}>
                <div>
                  ...
                  <h2 className={typography.TextLG}>
                    Track, compare and visualize your ML experiments
                  </h2>
                </div>
              </div>
            ...
            <div className={styles.HeroFeatures}>
              ...
              <div className={styles.HeroFeaturesItem}>
                ...
                <p
                  className={`${styles.HeroFeaturesItemDesc} ${typography.TextMD}`}
                >
                  Easy search, visualization and comparison for everything you
                  have tracked.
                </p>
              </div>
              <div className={styles.HeroFeaturesItem}>
                ...
                <p
                  className={`${styles.HeroFeaturesItemDesc} ${typography.TextMD}`}
                >
                  Plays seamlessly with wherever your code is: jupyter and colab
                  notebooks or python script.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className={styles.HowItWorksBody}>
              <div className={styles.HowItWorksList}>
                ...
                >
                  ...
                  <br />
                  - Use it to track all your ML metadata - hyperparams, metrics,
                  media, distribution, etc.
                  <br />
                  - Only two functions to integrate with your training code.
                  <br />
                  - Works with any python script, notebook and ML framework.
                  <br />
                  - Stores metadata logs locally and remotely.
            ...
            <div className={styles.FeatureBlocksGrid}>
              <div className={styles.FeatureBlocksContent}>
                ...
                <div className={styles.FeatureBlock}>
                  <h2 className={typography.TextLG}>Track and search</h2>
                  <p className={typography.TextMD}>
                    Log all important metadata into Aim and easily compare every
                    aspect of your runs— metrics, hyperparameters, dependencies,
                    system metrics, and more—to understand differences in model
                    performance.
                  </p>
                ...
                <div className={styles.FeatureBlock}>
                  <h2 className={typography.TextLG}>Visualize Anything</h2>
                  <p className={typography.TextMD}>
                    Aim's performant UI allows you to record, transform, compare
                    and visualize all metadata giving you full control over the
                    kind of comparisons you need to best visualize your runs.
                  </p>
                  <div className={styles.FeatureBlockDemo}>
                    <div className={styles.FeatureBlockDemoArea}>
                      <img
                ...
                <div className={styles.FeatureBlock}>
                  <h2 className={typography.TextLG}>
                    Log all your AI metadata
                  </h2>
                  <p className={typography.TextMD}>
                    Images, audio files, scatter plots. Log everything you need
                    for the granular analyses of your runs.
                  </p>
                  <div className={styles.FeatureBlockDemo}>
                    <div className={styles.FeatureBlockDemoArea}>
                      <img
              ...
              <div className={styles.GetInvolvedContent}>
                ...
                <h2 className={typography.TextLG}>
                  <a
                    ...
                    target="_blank"
                    onClick={() => onClickEventTracking("GitHub issues")}
                  >
