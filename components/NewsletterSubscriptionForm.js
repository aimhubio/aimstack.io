  ...
  function onSubmit() {
    if (regex.test(email)) {
      document.getElementById("checkbox-error").innerHTML === "" &&
        trackEvent(`[Homepage] successful subscription`);
    }
  }
    ...
    <div>
      <div className={`${styles.sibForm} sib-form`}>
        ...
        <div
          ...
          className={`${styles.sibFormContainer} sib-form-container`}
        >
          <div
            id="error-message"
            className={`${styles.sibFormMessagePanel} sib-form-message-panel`}
          >
          ...
          <div
            id="sib-container"
            className={`${styles.sibContainer} sib-container--large sib-container--vertical`}
          >
            <form
              id="sib-form"
              method="POST"
            ...
            >
              <div>
                <div
                  className={`${styles.sibFormBlock} ${styles.sibFormHeaderBlock} sib-form-block`}
                >
                  <p className={`${styles.sigFormHeader} ${typography.TextLG}`}>
                    Aim Newsletter
                  </p>
                </div>
              </div>
                ...
                <div className={`${styles.sibFormBlock} sib-form-block`}>
                  <div className="sib-text-form-block">
                    <p className={`${typography.TextMD} ${styles.sibFormText}`}>
                      ...
                      about our latest releases, tutorials and blog posts!
                    </p>
                  </div>
                </div>
              </div>
              <div>
                <div
                  className={`${styles.sibFormBlock} sib-input sib-form-block`}
                >
              ...
              <div>
                <div
                  className={`${styles.sibFormBlock} sib-captcha sib-form-block`}
                >
                  <div className="form__entry entry_block">
                    <div className="form__label-row ">
                      <script
              ...
              <div>
                <div
                  className={`${styles.sibFormBlock} ${styles.sibFormSubmitBlock} sib-form-block`}
                >
                  <button
